...
export function parseAmount(amount = "1", decimal = 6) {
    if (!amount) return "0"
...
export function formatAmount(balance, decimal = 6, _trimTrailingZeroes = false) {
    ...
    return _trimTrailingZeroes ? trimTrailingZeroes(result) : result;
}
/**
